...
const tex = `% auto-generated by scripts/sameplan.mjs — idiomatic vs same-SQL deep fetch
\\begin{table}[htbp]
  \\centering
  \\caption{Bounding the raw-execution component of the deep-fetch spread:
    ...
    (native-relative $${spread('postgres')}\\times$ on PostgreSQL,
    $${spread('mysql')}\\times$ on MySQL) bounds the raw-execution component.}
  \\label{tab:sameplan}
