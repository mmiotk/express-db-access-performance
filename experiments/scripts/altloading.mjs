...
\\begin{table}[htbp]
  ...
  \\caption{Alternative eager-loading sensitivity on the deep/nested fetch:
    ...
    and MikroORM switch from their idiomatic single join to select-in; in both cases
    the idiomatic default is the \\emph{faster} strategy, so their deep-fetch deficit
