...
${rows.join('\n    \\addlinespace\n')}
  ...
  \\end{adjustbox}
  \\vspace{2pt}
  {\\raggedright\\footnotesize M1 semantic admission; M2 treatment definition; R3 common-SQL raw-path sensitivity; R4 capacity characterization; R5 operating-point separation; R6 resource accounting; R7 implementation-review provenance. \\emph{Not reported} is not evidence that a control was never performed.\\par}
\\end{table}
`;
