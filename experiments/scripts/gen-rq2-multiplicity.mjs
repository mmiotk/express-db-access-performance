...
\\begin{table}[htbp]
  ...
  \\caption{Familywise correction across the whole RQ2 screen. Each of the 21 layer pairs on
    ...
    screen prospective: which pairs cross parity, and the $5\\%$ margin, remain
    outcome-informed, and the two campaigns share a host and the same seeded draws.}
  \\label{tab:rq2_multiplicity}
  \\begin{tabular}{l l r r l}
    \\toprule
    Pattern & Promoted pair & primary $p$ & validation $p$ & survives Holm \\\\
    \\midrule
${rowsTex}
    \\bottomrule
  \\end{tabular}
