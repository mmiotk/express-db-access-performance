...
sha256sum -c results/checksums.sha256      # verify the 34 archived raw-data files
npm ci
...
node scripts/ci-tables.mjs && node scripts/gen-tables.mjs && \
  node scripts/gen-r4-tables.mjs && node scripts/gen-r6-tables.mjs && node scripts/gen-tail.mjs && node scripts/gen-p99-significance.mjs && \
