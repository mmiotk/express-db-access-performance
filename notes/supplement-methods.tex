...
\begin{enumerate}
  ...
  \item \textbf{Same-host repetition is not environmental replication.} Report how
        ...
        repeats ``independent.''
  \item \textbf{Policy-selected documented treatment.} State the exact API, its documentation page and
...
on the deep fetch on their per-replicate throughput ratios with a two-sided paired
...
typical of a virtualized host (this study's own run-to-run CV reaches $13.6\%$ on the
