\begin{table}[htbp]
  ...
  \caption{Estimands defined in this study, consolidating the identification qualifications
    stated across the main text's Study Design and Results. Each quantity is
  ...
  \begin{tabular}{@{}p{2.7cm} p{4.0cm} p{4.0cm} p{2.7cm}@{}}
    ...
    Main text, deep-fetch and insert tables \\
    \addlinespace
    ...
    Supplement Table~S28; main text, Results (RQ2) \\
    \bottomrule
  \end{tabular}
  \end{adjustbox}
\end{table}
