\begin{table}[htbp]
  ...
  \begin{tabular}{@{}p{2.7cm} p{4.0cm} p{4.0cm} p{2.7cm}@{}}
    ...
    Performance of the configuration selected by the predeclared documentation-primary rule (throughput, p99) &
    ...
    p99 when each layer is offered equal fractions (50/70/85/95\%) of its estimated capacity proxy &
