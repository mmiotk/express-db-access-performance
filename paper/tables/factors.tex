...
\begin{table}[htbp]
  ...
  \caption{Factors in the benchmark: what is held constant, what varies (the
    ...
    mapping \emph{together}, its residual is a compound standardized contrast and
    does not isolate any single factor. The uncontrolled factors are inherent to a single virtualized
