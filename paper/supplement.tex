...
text. The primary-campaign tables are generated from the raw data archived with replication-package release v1.12.12 (\url{https://doi.org/10.5281/zenodo.21498786}). The current repository (\url{https://github.com/mmiotk/express-db-access-performance}) additionally carries the documentation archive and the standalone canonical-constructor measurement introduced in this revision; these additions have separate manifests and inputs.
...
reports the resulting smaller residual spread and reads it as a standardized-SQL contrast, not a
...
\begin{table}[htbp]
  ...
  \begin{tabular}{@{}p{0.24\textwidth} p{0.68\textwidth}@{}}
    ...
    Item & Detail \\
    \midrule
    Artifact \& version & \texttt{express-db-access-performance}, release v1.12.12 (git tag
      \texttt{v1.12.12}); the archive is a \texttt{git archive} of the tagged commit and
      contains every tracked file, including the raw data and the table generators. \\
    Persistent identifier & Zenodo \texttt{10.5281/zenodo.21498786} (concept
