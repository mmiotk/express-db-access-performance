...
estimators behind the tables in this supplement were implemented with assistance from Claude
(Anthropic); the models, affected components, and the checks that independently validate the
generated code are documented in the main text (Study Design, ``AI-assisted research tooling'').
Every table below is regenerated from archived raw records by a committed generator listed in
\texttt{MANIFEST.md}.
