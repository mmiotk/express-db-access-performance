...
The full point-by-point reply, each with a quotation of the revised text, is in the accompanying Response to Reviewers. The complete replication package remains public on GitHub and is permanently archived on Zenodo (DOI: 10.5281/zenodo.21470361); the numbered online supplement accompanies the manuscript.
