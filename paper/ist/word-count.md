...
| **Conservative IST submission equivalent** | **14,986** |

The controlling total is therefore **14,986 words**, leaving **14 words of headroom** under the 15,000-word limit. The structured abstract contains 295 words under the `texcount` sum convention, below the 300-word limit.
...
**The remaining headroom is 14 words.** Any further addition requires an offsetting cut, and this declaration must be regenerated with it.
