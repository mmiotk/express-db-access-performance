...
| Component | Count |
|---|---:|
| Seven body sections (`texcount` sum, including section headings and caption text encountered in those files) | 11852 |
...
| **Conservative IST submission equivalent** | **14,985** |

The controlling total is therefore **14,985 words**, leaving **15 words of headroom** under the 15,000-word limit. The structured abstract contains 295 words under the `texcount` sum convention, below the 300-word limit.
...
**The remaining headroom is 15 words.** Any further addition requires an offsetting cut, and this declaration must be regenerated with it.
...
Count date: 30 July 2026, at the v1.13.0 release commit. Any later prose or float change requires this declaration to be regenerated.
