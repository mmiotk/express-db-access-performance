...
| Component | Count |
|---|---:|
| Seven body sections (`texcount` sum, including section headings and caption text encountered in those files) | 11862 |
...
| **Conservative IST submission equivalent** | **14,996** |

The controlling total is therefore **14,996 words**, leaving **4 words of headroom** under the 15,000-word limit. The structured abstract contains 295 words under the `texcount` sum convention, below the 300-word limit.
...
**The remaining headroom is 4 words.** Any further addition requires an offsetting cut, and this declaration must be regenerated with it.
